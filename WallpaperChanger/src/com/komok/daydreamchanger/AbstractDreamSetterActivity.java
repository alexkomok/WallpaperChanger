...
abstract class AbstractDreamSetterActivity extends Activity {

	private static final String TAG = "AbstractDreamSetterActivity";
	...
	protected void onStart() {
		super.onStart();
		Thread.setDefaultUncaughtExceptionHandler(new ExceptionHandler(this));
		ApplicationHolder wallpaper = getApp();
		...
		if (!isSuccess) {
			...
			intent = new Intent(this, DayDreamSelectionActivity.class);
